...
Shader "SH_WaterSplash"
{
	Properties
	{
		...
		_T_Water_Splater("T_Water_Splater", 2D) = "white" {}
	...
	SubShader
	{
		...
		#pragma surface surf StandardSpecular keepalpha finalcolor:RefractionF  
		struct Input
		{
			float2 uv_texcoord;
			float4 screenPos;
		...
		uniform sampler2D _T_Water_Splater;
		uniform float4 _T_Water_Splater_ST;
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 uv_T_Water_Splater = i.uv_texcoord * _T_Water_Splater_ST.xy + _T_Water_Splater_ST.zw;
			half4 tex2DNode169 = tex2D( _T_Water_Splater,uv_T_Water_Splater);
			...
			o.Albedo = lerp( _WaterColor , ( tex2DNode169 * tex2D( WaterGrab, ( half3( ( appendResult67 / i.screenPos.w ) ,  0.0 ) + ( temp_output_24_0 * _Distortion ) ).xy ) ) , saturate( pow( ( abs( ( eyeDepth1 - i.screenPos.w ) ) + _WaterDepth ) , _WaterFalloff ) ) ).rgb;
			o.Occlusion = _Occlusion;
			o.Alpha = tex2DNode169.x;
...
/*ASEBEGIN
Version=7003
629;201;1632;970;-575.3945;1142.084;1.3;True;True
...
Node;AmplifyShaderEditor.SamplerNode;169;1408.694,-271.0836;Float;True;Property;_T_Water_Splater;T_Water_Splater;11;0;Assets/VFX/Textures/T_Water_Splater.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;170;1603.695,-1217.484;Float;False;0;FLOAT4;0,0,0,0;False;1;COLOR;0,0,0,0;False;COLOR
...
ASEEND*/
//CHKSM=D2F559996181C5146B67C35C73FB4AA4E47B351F